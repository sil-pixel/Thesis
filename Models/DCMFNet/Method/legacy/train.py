'''
Legacy research training workflow retained for historical analysis scripts.

New training and export code lives in dcmfnet.training.
...
HYPERPARAMETERS_PATH = Path(__file__).resolve().parents[2] / "hyperparameters.json"
with HYPERPARAMETERS_PATH.open("r", encoding="utf-8") as f:
